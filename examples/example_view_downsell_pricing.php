...
if(!empty($_GET['downsell_id'])) {
	...
	echo '<div class="notification is-danger is-light">This example can only be accessed by providing a <code>downsell_id</code> parameter to look up a single downsell! Check out the <a href="example_list_downsells.php?access_token='.$access_token.'">list downsells</a> example for a demonstration!</div>';
}
