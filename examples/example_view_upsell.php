...
if(!empty($_GET['upsell_id'])) {
	...
	echo '<div class="notification is-danger is-light">This example can only be accessed by providing a <code>product_id</code> parameter to look up a single upsell! Check out the <a href="example_list_upsells.php?access_token='.$access_token.'">list upsells</a> example for a demonstration!</div>';
}
